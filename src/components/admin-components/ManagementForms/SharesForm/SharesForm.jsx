...
const SharesForm = () => {
    ...
    const handleSubmit = (values, { setSubmitting, resetForm }) => {
        ...
        axios.post('https://vintage-wine-l5ax0zanr-sviats-projects-0463f59c.vercel.app/api/shares/', rest, {
            headers: {
                "Authorization": token,
            }
        })
            .then((excursion) => {
                ...
                axios.put(`https://vintage-wine-l5ax0zanr-sviats-projects-0463f59c.vercel.app/api/shares/images/${excursion.data._id}`, formData, {
                    headers: {
                        "Authorization": token,
